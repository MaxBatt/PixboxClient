 ...
 * image the image is opened in gallery. On long click on an image you can
 * delete the image, copy the public url of the image and also show it in
 * gallery
 * 
 * @author Max Batt
 * 
					...
					public void onSuccess(String response) {
						...
						if (imageList.size() > 0) {
							...
							adapter = new GalleryListAdapter(
									GalleryActivity.this, imageList);
